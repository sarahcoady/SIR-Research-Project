...
\newpage
Epidemic modelling (EM) is an important tool in epidemiology using various mathematical tools to help study and predict the spread of real world infectious diseases (NLM). There is a wide range of epidemic models, each using different assumptions about the observed population and the transmission of the disease. This project will study the Susceptible, infected, Removed (SIR) model. Specifically, we will test how accurate the SIR model is at producing real world infectious disease outbreak patterns across two phases, the early growth phase and the mid stage, close to its peak. This will be accomplished by comparing curves acquired from both the SIR model and real historical data. By applying the SIR model to real outbreaks we can examine where it successfully replicates real patterns and where it fails. Understanding the spread of infectious disease will always be highly important to our soceity. Thus, it is important to have a strong understanding of this model. Knowing its strengths and limitations allows for correct application. We will apply the SIR model to the historical records of both Measles and COVID-19 during specific, specified time periods, as these are two highly contagious and historically impactful infectious diseases.
...
A SIR model will be created using assumptions and data obatined from peer-reivwed journals on both measles and COVID-19. The simulated outbreak patterns from both previously stated phases will be compared to real world outbreak patters, whos data will be taken directly from public health records, to access the strengths and weakness of the SIR model. This will be done by comparing the SIR models predicted outbreak curves to the corresponding observed outbreak curves from historical data.
