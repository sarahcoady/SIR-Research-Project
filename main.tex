...
A SIR model will be created using assumptions and data provided by journals and papers on both measels and COVID-19. The simulated outbreak patterns from both previously stated phases will be compared to real world outbreak patters to access the strengths and weakness of the SIR model. This can be done by compairing the SIR models perdicted outbreak curves to the corresponding observed outbreak curves.
